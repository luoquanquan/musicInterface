...
![2018-12-24-22-58-59](http://img.blog.niubishanshan.top/2018-12-24-22-58-59.png)
...
字段 | 字段类型  | 字段说明
--- | --- | ---
songIdList | stringArray | 歌曲 id 列表, 需要拼接成 `id1,id2,id3,id4` 的形式
